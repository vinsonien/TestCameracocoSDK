...
import com.cjt2325.cameralibrary.util.CameraLogUtil;
...
//    private static final String TAG = "JCameraView";
    ...
    private int fragMarginTop = 0;     //右上两个按钮整体边距
    private int fragMarginRight = 0;     //右上两个按钮整体边距
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        fragMarginTop = a.getDimensionPixelSize(R.styleable.JCameraView_fragMarginTop, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
        fragMarginRight = a.getDimensionPixelSize(R.styleable.JCameraView_fragMarginRight, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
    ...
    private void initView() {
        ...
        fragLayout = (LinearLayout) view.findViewById(R.id.fragLayout);
        ...
        setFlashRes();
        FrameLayout.LayoutParams lp = (LayoutParams) fragLayout.getLayoutParams();
        lp.setMargins(lp.leftMargin,fragMarginTop,
                lp.bottomMargin, fragMarginRight);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void startPreviewCallback() {
        CameraLogUtil.i("startPreviewCallback");
